...
#include "state_estimate_filter_confidential\state_estimate_filters.h"
#include "state_estimate_filter_confidential\state_estimater_factory.h"
#include "state_estimate_filter_confidential\low_variance_sampling.h"
#include "state_estimate_filter_confidential\truth_observation_generator.h"
...
namespace state_estimate_filter_test
{
    ...
    void TestParticleFilterThree()
    {
      ...
      {
        //      w(1)-[k],        w(1)[k],        mmse[k]
        { 1. / 3.,           0.323976344, 2.961861349 },
        { 0.323976344411132, 0.235164533, 1.819859261 },
        { 0.235164533256779, 0.449218958, -0.985556304},
      };
      double AnswersPfMap[3] =
      { 2.4702660458708, 3.80532604267008, 0.53697060403095254 };
      ...
      for (int k = 0; k < 3; k++)
      {
        ...
        EstimationResult^ est = gcnew EstimationResult();
        filter->AcquireEstimationResult(est);
      }
    }
    ...
    void TestParticleFilterThreeWithTwoSensors()
    {
      ...
      {
        //  w(1)-[k],    w(1)[k],      mmse[k]
        { 1. / 3.,     0.457441544, 1.696108847 },
        { 0.457441544, 0.337308874, 3.763503448 },
        { 0.337308874, 0.784367369, 1.060221671 },
      };
      double AnswersPfMap[3] =
